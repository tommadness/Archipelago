...
from . import options as replaylee_options  # rename due to a name conflict with World.options
...
class ReplayleeWorld(World):
    ...
    options_dataclass = replaylee_options.ReplayleeOptions
    options: replaylee_options.ReplayleeOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
