...
def set_all_entrance_rules(world: ReplayleeWorld) -> None:
    ...
    ht_near_tt = world.get_entrance("Hivory Towers ramp to TT")
    tt_start_island = world.get_entrance("Hivory Towers to TT Start Island")
    tt_near_shovel_knight = world.get_entrance("TT Start Island to Near Shovel Knight")
